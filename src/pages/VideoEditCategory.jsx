...
import { VEArrowRightIcon } from '../components/VEIcons';

export default function VideoEditCategory() {
  ...
  if (!category) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center">
        ...
        <Link to="/video-editing" className="mt-4 underline underline-offset-4">Back to home</Link>
      </div>
    );
  }
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="border-b border-black bg-[#f5f5f5]">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <Link
            to="/video-editing"
            className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-neutral-500 hover:text-black mb-8 transition-colors"
          >
            <VEArrowRightIcon size={16} className="rotate-180" />
            Back to Categories
          </Link>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="border-4 border-black border-dashed py-32 px-4 flex flex-col items-center justify-center bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[8px] hover:translate-y-[8px] transition-all duration-300">
          ...
          <div className="mt-10">
            <Link
              to="/video-editing"
              className="inline-flex items-center justify-center border border-black bg-black px-8 py-4 text-xs font-bold uppercase tracking-widest text-white transition-transform hover:-translate-y-1 hover:shadow-lg"
            >
              Return Home
            </Link>
          </div>
