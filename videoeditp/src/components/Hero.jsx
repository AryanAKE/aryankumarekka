  ...
  return (
    ...
    >
      {Array.from({ length: layers }).map((_, index) => {
        const baseOffset = index; // 0 for front, 1..7 for back layers
        ...
        return (
          <span
            ...
            style={{
              ...
              zIndex: layers - index, // front layer is highest
            }}
          >
            {text}
          </span>
...
export default function Hero() {
  return (
    <section className="border-b border-black relative bg-white">
      {/* 3 Column Grid: Left Content (auto), Divider (60px), Right Content (auto) */}
      <div className="mx-auto w-full lg:grid lg:grid-cols-[1fr_60px_1fr] lg:min-h-[85vh]">
        
        {/* Left Side: Text Content */}
        <div className="px-4 py-16 sm:px-6 lg:px-12 lg:py-24 flex flex-col justify-center lg:min-h-[85vh] relative bg-white pb-24">
        ...
        <div className="hidden lg:block border-l border-r border-black relative overflow-hidden bg-white">
          <div 
            className="absolute left-1/2 top-0 -translate-x-1/2 text-2xl font-bold tracking-widest text-black flex flex-col gap-12 animate-marquee-vertical-down w-full items-center"
        ...
        {/* Right Side */}
        <div className="relative bg-[#f5f5f5] border-t border-black lg:border-t-0 flex items-center justify-center p-8 overflow-hidden lg:overflow-visible">
          {/* Side Label */}
